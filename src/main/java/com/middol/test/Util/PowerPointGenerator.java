package com.middol.test.Util;

import com.middol.test.Exception.ReportErrorEnum;
import com.middol.test.Exception.ReportExcetion;
...
//        System.out.println(table.getCell(1,0).getText());
            ...
            if (i < rowSize) {
                ...
                for (int j = 0; j < tableDataList.get(i).getDataList().size(); j++) {
                    ...
                    String s = tableDataList.get(i).getDataList().get(j);
                       while (k<cells.size()){
                            if (cells.get(k).getText() == null || cells.get(k).getText().equals("")) {
                                    cells.get(k).setText(s).setFontColor(Color.BLACK);
                                    break;
                            }
                            k++;
                        }
