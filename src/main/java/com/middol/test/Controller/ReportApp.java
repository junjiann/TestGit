...
//        PowerPointGenerator.generatorPowerPoint(templateFile, resultFile, data);
    ...
    private static Map<Integer, SlideData> getData() {
        ...
        //2页表格
          ...
          slideData4.setTextMap(textDataTest2);
          List<TableData> tableTest = getTableTest();
          slideData4.setTableDataList(tableTest);

          map.put(6, slideData4);
          map.put(7, slideData4);
        /*//3页饼图
    ...
    private static Map<String, String> getTextDataTest() {
        ...
        textMap.put("title", "测试成功Axxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
        textMap.put("teammembers", "测试成功B\n嘻嘻");
        return textMap;
    }

    private static Map<String, String> getTextDataTest2() {
        Map<String, String> textMap = new HashMap<>();
        textMap.put("jr2","测试成功D");
        return textMap;
    }
    ...
    private static List<TableData> getTableTest() {
        ...
        strings11.add("测试成功A1111111111111111111111111111111111111111111111111111111111111111111111111111111");
        strings11.add("测试成功B2222222222222222222222222222222222222222222222222222222222222222222222222222222");
        strings11.add("测试成功C3333333333333333333333333333333333333333333333333333333333333333333333333333333");
        tableRowData1.setDataList(strings11);
        TableRowData tableRowData2 = new TableRowData();
        List<String> strings12 = new ArrayList<>();
        strings12.add("测试成功C111111111111111111111111111111111111111111111111111111111111111111111111111111111111111");
        strings12.add("测试成功B222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222");
        strings12.add("测试成功A333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333");
